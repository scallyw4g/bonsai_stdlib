...
enum c_token_type
{
  ...
  CT__ControlChar_Start_of_Heading          = 1,
  CT__ControlChar_Start_of_Text             = 2,
  CT__ControlChar_End_of_Text               = 3,
  CT__ControlChar_End_of_Transmission       = 4,
  CT__ControlChar_Enquiry                   = 5,
  CT__ControlChar_Acknowledgement           = 6,
  CT__ControlChar_Bell                      = 7,
  CT__ControlChar_Backspace                 = 8,
  /* CT_ControlChar_Horizontal_Tab            = 9, */
  /* CT_ControlChar_Line_Feed                 = 10, */
  CT__ControlChar_Vertical_Tab              = 11,
  CT__ControlChar_Form_Feed                 = 12,
  /* CT_ControlChar_Carriage_Return           = 13, */
  CT__ControlChar_Shift_Out                 = 14,
  CT__ControlChar_Shift_In                  = 15,
  CT__ControlChar_Data_Link_Escape          = 16,
  CT__ControlChar_Device_Control_1          = 17,
  CT__ControlChar_Device_Control_2          = 18,
  CT__ControlChar_Device_Control_3          = 19,
  CT__ControlChar_Device_Control_4          = 20,
  CT__ControlChar_Negative_Acknowledgement  = 21,
  CT__ControlChar_Synchronous_Idle          = 22,
  CT__ControlChar_End_of_Transmission_Block = 23,
  CT__ControlChar_Cancel                    = 24,
  CT__ControlChar_End_of_Medium             = 25,
  CT__ControlChar_Substitute                = 26,
  CT__ControlChar_Escape                    = 27,
  CT__ControlChar_File_Separator            = 28,
  CT__ControlChar_Group_Separator           = 29,
  CT__ControlChar_Record_Separator          = 30,
  CT__ControlChar_Unit_Separator            = 31,
  CT__ControlChar_Delete                    = 127,
  ...
  // C11 keyword
  CT__Keyword_Noreturn,

  CT__Keyword_Override,
  CT__Keyword_Virtual,
  CT__Keyword_Noexcept,
  CT__Keyword_Explicit,
  CT__Keyword_Constexpr,
  CT__Keyword_Namespace,
  CT__Keyword_Class,
  CTokenType_Struct,
  CTokenType_Enum,
  CTokenType_Union,
  ...
  CT__Keyword_Public,
  CT__Keyword_Private,
  CT__Keyword_Protected,

  CT__KeywordPragma,
  CT__KeywordAttribute,
  ...
  CT__ScopeResolutionOperator,
  CT__NameQualifier,

  CT__MacroLiteral,
  CT__MacroLiteral_SelfRefExpansion,

  CT__PreprocessorHasInclude,
  CT__PreprocessorHasIncludeNext,
  CT__PreprocessorPaste,
  CT__PreprocessorPaste_InvalidToken,

  CT__PreprocessorInclude,
  CT__PreprocessorIncludeNext,

  CT__PreprocessorIf,
  CT__PreprocessorElse,
  CT__PreprocessorElif,
  CT__PreprocessorEndif,
  CT__PreprocessorIfDefined,
  CT__PreprocessorIfNotDefined,
  CT__PreprocessorDefine,
  CT__PreprocessorUndef,
  CT__PreprocessorPragma,
  CT__PreprocessorError,
  CT__PreprocessorWarning,
  CT__Preprocessor_VA_ARGS_,
  CT__Preprocessor_Nuked,

  CT__InsertedCode,     // This is how macros and includes get inserted

  CT__PoofInsertedCode, // This hijacks an existing token so poof can insert arbitrary stuff into source files
  CT__PoofModifiedToken,
};
