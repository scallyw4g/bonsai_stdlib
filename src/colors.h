...
//  NOTE(Jesse): Seeded with magicavoxel default palette
//  RR GG BB AA
static s32 Global_ColorPaletteAt = 0xff + 1;
static v3 Global_ColorPalette[u16_MAX] = {
  V3( 0x01, 0x01, 0x01), // 0
  V3( 0xff, 0xff, 0xff), // 1
  V3( 0xff, 0xff, 0xcc), // 2
  V3( 0xff, 0xff, 0x99), // 3
...
CAssert( ArrayCount( Global_ColorPalette ) == (0xffff) );

inline v3
GetColorData(u32 ColorIndex)
{
  Assert(ColorIndex < u32(Global_ColorPaletteAt));
  v3 Result = Global_ColorPalette[ColorIndex] / 255.f;
  return Result;
}
...
inline void
FillColorArray(u32 ColorIndex, v3 *Dest, s32 Count)
{
  v3 ColorData = GetColorData(ColorIndex);
