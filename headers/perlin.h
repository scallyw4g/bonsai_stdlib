...
double
perlin_noise::noise(double x, double y, double z) {
...
double
perlin_noise::fade(double t) {
  double res = t * t * t * (t * (t * 6 - 15) + 10);
  return res;
}

double
perlin_noise::lerp(double t, double a, double b) {
  double res = a + t * (b - a);
  return res;
}

double
perlin_noise::grad(int hash, double x, double y, double z) {
  int h = hash & 15;
